...
Function Create-Form
{
    ...
    $toolStripItemUnlockAccount.add_Click()
    ...
    $toolStripItemResetPassword.add_Click()
    ...
    $toolStripItemEnableAccount.add_Click()
    ...
    $toolStripItemHomeDrive.add_Click($ClickElementMenu)
    ...
    $toolStripItemCopy.add_Click($ClickElementMenu)
...
Function Get-UserNameSessionIDMap
{
    ...
    (
        ...
        $quserRes = quser /server:$ComputerName | select -skip 1
...
Get-UserNameSessionIDMap -Comp PW3695 # $env:COMPUTERNAME
